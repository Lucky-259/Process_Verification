...
def load_reward_manager(config, tokenizer, num_examine, train_batch_size, num_generation, beta, **reward_kwargs):
    """
    ...
    # Instantiate and return the RewardManager Class with the specified parameters
...
def compute_reward(data: DataProto, reward_fn):
    ...
    Args:
        ...
        reward_fn: Reward function to compute the reward. This is the __call__ function inside the RewardManager Class.
    Returns:
