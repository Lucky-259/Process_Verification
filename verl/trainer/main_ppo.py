...
class TaskRunner:
    ...
    def run(self, config):
        ...
        reward_fn = load_reward_manager(
            config, tokenizer, num_examine=0, train_batch_size=train_batch_size, num_generation=num_generation, beta =config.algorithm.beta, **config.reward_model.get("reward_kwargs", {})
        )
        val_reward_fn = load_reward_manager(
            config, tokenizer, num_examine=1, train_batch_size=train_batch_size, num_generation=num_generation, beta =config.algorithm.beta, **config.reward_model.get("reward_kwargs", {})
        )
