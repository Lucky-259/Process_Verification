...
def register(name):
    ...
    """
    # cls is the RewardManager Class, got by executing '@register("naive")'
    def decorator(cls):
        ...
        # if REWARD_MANAGER_REGISTRY[name] doesn't has RewardManager class, map it REWARD_MANAGER_REGISTRY[name] to its class
